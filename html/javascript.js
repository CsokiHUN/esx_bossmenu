...
$(document).on('click', '.fireemployee', function (e) {
  ...
  $.post(
    'https://qb-bossmenu/fireEmployee',
    JSON.stringify({
      source: playerid,
    })
  );
...
$(document)
  .on('mouseenter', '.player-box', function (event) {
    var id = $(this).attr('id');
